      ...
      <div>
        <div className='row shadow-lg'>
          ...
          <div className='col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 pt-5 g-3 '> <h4 className='text-uppercase text-black-50 w-100 pt-5'>{subtitle}</h4>
            ...
            <p className='text-dark'>{des}<br></br>Authors:     {authors}<br></br>Publisher:     {publisher}<br></br>Pages:     {pages}<br></br>Year:     {year}<br></br>Rating:     {rating}</p>
          </div>
        </div>
      </div>
    )
